...
QT_MOC_LITERAL(3, 22, 24), // "scanNetwork_printResults"
QT_MOC_LITERAL(4, 47, 9), // "QHostInfo"
QT_MOC_LITERAL(5, 57, 4) // "host"

    },
    "NetworkScan\0finished\0\0scanNetwork_printResults\0"
    "QHostInfo\0host"
};
...
void NetworkScan::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->scanNetwork_printResults((*reinterpret_cast< QHostInfo(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkScan::finished)) {
                *result = 0;
                return;
            }
        }
