...
QT_MOC_LITERAL(1, 16, 8), // "received"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "NetworkProtocol\0received\0"
};
...
void NetworkProtocol::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NetworkProtocol *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (NetworkProtocol::*)(QByteArray );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkProtocol::received)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject NetworkProtocol::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_NetworkProtocol.data,
    qt_meta_data_NetworkProtocol,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void NetworkProtocol::received(QByteArray _t1)
{
